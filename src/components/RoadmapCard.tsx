...
export default function RoadmapCard({ stage }: any) {
  ...
  return (
    <motion.div
      ...
      className="relative group rounded-2xl p-[2px] cursor-pointer"
    >
      <div
      ...
      <div className="relative rounded-2xl bg-[#0a1025]/70 backdrop-blur-lg border border-white/10 p-6 transition-all duration-500">
